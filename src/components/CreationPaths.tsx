        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="bg-card rounded-xl p-8 md:p-10 border border-border/60 shadow-sm hover:shadow-md transition-shadow duration-500">
            ...
            <p className="font-body text-muted-foreground leading-relaxed mb-4">
              Transform your modern thoughts into intimate, poetic letters —
              written as though meant to be folded, sealed, and cherished.
            </p>
            ...
            <Button
              variant="rose"
              className="w-full font-elegant text-base tracking-wide"
            >
              <Link to="/love-letter">Begin a Letter</Link>
            </Button>
          </div>
          ...
          <div className="bg-card rounded-xl p-8 md:p-10 border border-border/60 shadow-sm hover:shadow-md transition-shadow duration-500">
            ...
            <p className="font-body text-muted-foreground leading-relaxed mb-4">
              Announce life's milestones through refined society papers in the
              style of Lady Whistledown — addressed to dearest gentle readers.
            </p>

            <p className="font-display text-sm italic text-gold/70 mb-6 leading-relaxed">
              "Dearest Gentle Reader, this author brings you the most delighthat
              of news..."
              <span className="font-elegant not-italic text-xs text-muted-foreground ml-1">
                — Lady Whistledown
              </span>
            ...
            <Button
              ...
              className="w-full font-elegant text-base tracking-wide"
            >
              <Link to="/society-announcement">Create an Announcement</Link>
            </Button>
          </div>
        </div>
      </div>
